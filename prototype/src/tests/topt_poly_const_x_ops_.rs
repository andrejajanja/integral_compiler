...
fn seq_3(){
    ...
    optimize_postfix_using_tylor(&mut sequence, 0.0, 3);
...
fn seq_7(){
    ...
    optimize_postfix_using_tylor(&mut sequence, 0.0, 2);
...
fn seq_11(){
    ...
    optimize_postfix_using_tylor(&mut sequence, 0.0, 4);
...
fn seq_12(){
    ...
    optimize_postfix_using_tylor(&mut sequence, 0.0, 5);
